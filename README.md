...
- **[2026-08] `INTE`:** Feishu (Lark), Discord, and Telegram channels supported. [Feishu](https://docs.agentscope.io/latest/en/deploy/channel/feishu) | [Discord](https://docs.agentscope.io/latest/en/deploy/channel/discord) | [Telegram](https://docs.agentscope.io/latest/en/deploy/channel/telegram)
