...
class AgentBase(StateModule, metaclass=_AgentMeta):
    ...
    def clear_all_obj_hooks(self) -> None:
        ...
        self.clear_instance_hooks("pre_reply")
        self.clear_instance_hooks("post_reply")
        self.clear_instance_hooks("pre_observe")
        self.clear_instance_hooks("post_observe")
        self.clear_instance_hooks("pre_print")
        self.clear_instance_hooks("post_print")
