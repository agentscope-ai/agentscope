...
class Bash(ToolBase):
    ...
    description: str = """Executes a given bash command and returns its output.
  ...
  - If you must sleep, keep the duration short (1-5 seconds) to avoid blocking the user."""
    ...
    input_schema: dict[str, Any] = {
        ...
        "properties": {
            ...
            "description": {
                "type": "string",
                "description": "Clear, concise description of what this command does. For simple commands, keep it brief (5-10 words). For complex commands, include enough context.",
            },
            "timeout": {
                "type": "integer",
