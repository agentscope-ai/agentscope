...
class RedisSession(SessionBase):
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            ttl (`int | None`, optional):
                ...
                the expiration will be refreshed on
                every save/load (sliding TTL). If `None`, the session state
                will not expire.
            prefix (`str`, default to `""`):
    ...
    def _k(self, key: str) -> str:
        """Apply the configured prefix to a Redis key."""
