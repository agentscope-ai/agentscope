...
DEFAULT_AGGREGATOR_PROMPT = """You have been provided with a set of responses from various open-source model to the latest user query. Your task is to synthesize these responses into a single, high-quality response. It is crucial to critically evaluate the information provided in these responses, recognizing that some of it may be biased or incorrect. Your response should not simply replicate the given answers but should offer a refined, accurate, and comprehensive reply to the instruction. Ensure your response is well-structured, coherent, and adheres to the highest standards of accuracy and reliability.

Responses from model:"""  # noqa


class MixtureOfAgents:
    """
    The MoA model that take multiple model and aggregate their responses,
    ...
    def __init__(
        ...
        Args:
            main_model (`Union[str, ModelWrapperBase]`):
                ...
                round, summarizing all the previous responses from model.
            ...
            reference_models (`List[Union[str, ModelWrapperBase]]`):
                ...
                in each round.
                Can take both config name of model or model instance as input.
                We encourage using different model to get better diversity.
                Empirically, responses generated by heterogeneous model
