import "./chunk-AGBRHPVX.js";
import {
  AsyncDirective
} from "./chunk-BZ4WJLVS.js";
import "./chunk-LF2AWOUF.js";
import {
  html,
  svg
} from "./chunk-W74ZIG4F.js";
import {
  directive
} from "./chunk-6LQYB6KZ.js";
...
function createComputed(computation) {
  ...
  const computed2 = () => computedGet(node);
...
((Signal2) => {
  ...
  ((subtle2) => {
    ...
    function introspectSinks(signal2) {
      var _a3;
      if (!(0, Signal2.isComputed)(signal2) && !(0, Signal2.isState)(signal2)) {
        throw new TypeError("Called introspectSinks without a Signal argument");
      }
      return ((_a3 = signal2[NODE].liveConsumerNode) == null ? void 0 : _a3.map((n) => n.wrapper)) ?? [];
    }
    subtle2.introspectSinks = introspectSinks;
    function hasSinks(signal2) {
      if (!(0, Signal2.isComputed)(signal2) && !(0, Signal2.isState)(signal2)) {
        throw new TypeError("Called hasSinks without a Signal argument");
      }
      const liveConsumerNode = signal2[NODE].liveConsumerNode;
      if (!liveConsumerNode)
        return false;
      return liveConsumerNode.length > 0;
    }
    subtle2.hasSinks = hasSinks;
    function hasSources(signal2) {
      if (!(0, Signal2.isComputed)(signal2) && !(0, Signal2.isWatcher)(signal2)) {
        throw new TypeError("Called hasSources without a Computed or Watcher argument");
      }
      const producerNode = signal2[NODE].producerNode;
      if (!producerNode)
        return false;
