...
+++ b/package.json	(date 1758940198140)
@@ -8,6 +8,7 @@
   "license": "Apache-2.0",
   "dependencies": {
     "google-auth-library": "^9.14.0",
...
+++ b/src/main.js	(date 1758940421439)
@@ -21,6 +21,7 @@
 const { logger } = require('./logger');
 const update = require('./update');
 const fs = require('fs');
...
+++ b/package-lock.json	(date 1758940198136)
@@ -10,6 +10,7 @@
       "license": "Apache-2.0",
       "dependencies": {
         "google-auth-library": "^9.14.0",
...
--- /dev/null	(date 1758940070953)
+++ b/test/test.update-yarn.js	(date 1758940070953)
@@ -0,0 +1,58 @@
...
new file mode 100644
--- /dev/null	(date 1758940577810)
+++ b/src/update-yarn.js	(date 1758940577810)
@@ -0,0 +1,62 @@
