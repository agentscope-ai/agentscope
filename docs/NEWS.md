...
- **[2026-06] `FEAT`:** Event system improvements — iteration extension events for human-in-the-loop loop-limit handling, and a general-purpose, customizable status event mechanism. [Docs](https://docs.agentscope.io/v2/building-blocks/message-and-event)
